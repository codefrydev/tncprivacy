...
date: "2026-05-24"
description: "Master Terms and Conditions governing all CodeFryDev digital properties, services, applications, and software."
tags: ["CFD", "CodeFryDev", "Terms", "General"]
---
...
- **"Digital Properties"** all websites, Applications, APIs, platforms, and services operated by the Service Provider, including the **CodeFryDev Ecosystem** hosted at `codefrydev.in`, its subdomains, path-based applications (e.g. `/games/`, `/JsonPlayground/`, `/ai/`), mobile applications, and any successor domains or platforms listed or referenced in Schedule E.

- **"CodeFryDev Ecosystem"** the interconnected portfolio of digital products, tools, games, utilities, documentation sites, and experimental services published under the CodeFryDev brand and accessible via [codefrydev.in](https://codefrydev.in/) and associated URLs identified in Schedule E, whether accessed individually or collectively.

- **"Analytics Services"** third-party measurement and intelligence platforms deployed across the CodeFryDev Ecosystem, presently including **Google Analytics** (Measurement ID: `G-VM01Q3R43D`) and **Microsoft Clarity** (Project ID: `mxr4hxioh4`), together with any successor or supplementary analytics tools the Service Provider may deploy upon updating the Privacy Policy.

- **"Session Recording"** technology that captures interaction data—including clicks, scroll behaviour, pointer movement, and page composition—for replay and heatmap analysis, as implemented through Microsoft Clarity and analogous services.
...
- **"Product Licence"** means the open source or proprietary licence under which a specific Digital Property's source code is published, as identified in the `LICENSE`, `LICENCE`, or `COPYING` file in the corresponding source repository or product documentation.

- **"Copyleft Licence"** means an open source licence (such as GPL or AGPL) requiring derivative works distributed in certain forms to be licensed under the same or compatible terms.
...
Personal Data processing is governed by the [General Privacy Policy](/privacy/general/), incorporated by reference.
...
Notices to the Service Provider: **CodeFryDev**, [codefrydev@gmail.com](mailto:codefrydev@gmail.com).
...
1. Attempting unauthorised access to infrastructure, Accounts, or administrative interfaces.

2. Using the Services to distribute pirated software, media, or counterfeit goods.

3. Operating botnets, cryptomining malware, or command-and-control infrastructure.

4. Conducting social engineering attacks against other users or staff.

5. Publishing content that violates applicable obscenity, hate speech, or harassment laws.

6. Using geo-evasion tools to access Services from embargoed territories where prohibited.

7. Reselling API access or Account credentials on secondary markets.

8. Automated creation of Accounts for promotional spam or fake engagement.

9. Deep-linking to bypass paywalls or authentication where prohibited.

10. Reverse engineering authentication tokens or session management schemes.

11. Uploading content containing active exploits targeting users or infrastructure.

12. Using the Digital Properties to stalk, surveil, or unlawfully monitor individuals.

13. Falsifying geolocation, device identifiers, or telemetry to commit fraud.

14. Interfering with disaster recovery, backup, or logging systems.

15. Publishing others' trade secrets or confidential information without authority.
...
Google Analytics operates as a **Subprocessor** under Google's terms and privacy policies. Data collected may be processed on servers located outside your country of residence. The Service Provider configures Analytics for legitimate interest in product improvement and, where required, relies upon consent obtained through your continued use of the Digital Properties after reviewing the [Privacy Policy](/privacy/general/).

You may learn about Google's practices at [https://policies.google.com/privacy](https://policies.google.com/privacy) and may install Google's opt-out browser add-on or adjust ad/analytics preferences made available by Google.
...
Microsoft processes Clarity data under its privacy terms at [https://privacy.microsoft.com](https://privacy.microsoft.com). Clarity operates as a Subprocessor.
...
Further detail regarding cookie categories and retention is provided in the [Privacy Policy](/privacy/general/).
...
(e) contacting [codefrydev@gmail.com](mailto:codefrydev@gmail.com) with analytics-related privacy requests, subject to verification and applicable law.
...
Matters concerning legal bases for processing, data subject rights, international transfers, and subprocessors are elaborated in the [Privacy Policy](/privacy/general/). This Article establishes your **contractual acknowledgment** that Analytics Services are integral to the operation and improvement of the CodeFryDev Ecosystem.
...
| --- | --- |
| Core Platform | [/term/core/](/term/core/) |
| Artificial Intelligence | [/term/ai/](/term/ai/) |
| Developer Tools & Utilities | [/term/tools/](/term/tools/) |
| Design & Creative | [/term/design/](/term/design/) |
| Educational | [/term/education/](/term/education/) |
| Games & Entertainment | [/term/games/](/term/games/) |
| Hardware & Embedded | [/term/hardware/](/term/hardware/) |
| Mobile Applications | [/term/water/](/term/water/) (Water App) |
...
Any product added to the CodeFryDev Ecosystem after publication of this Schedule—including entries subsequently added to [codefrydev.in/sitemap.xml](https://codefrydev.in/sitemap.xml)—is governed by this Agreement and Article 43 from the date of public availability.
...
1. retain the copyright notice and MIT Licence text;
2. document material modifications where appropriate;
3. comply with dependency licences specified in `package.json`, `go.mod`, or equivalent manifest files;
4. **refrain from** employing CodeFryDev trade marks in a manner suggesting official affiliation of the derivative work; and
5. accept the software **"AS IS"**, without warranty from the Service Provider.
...
Email: [codefrydev@gmail.com](mailto:codefrydev@gmail.com)  
...
| Accessibility Statement | [/term/accessibility/](/term/accessibility/) |
| Trade Mark Guidelines | [/term/trademark/](/term/trademark/) |
| DMCA / Copyright Policy | [/term/dmca/](/term/dmca/) |

---

## Schedule G — Cookie and Local Storage Categories

See the dedicated [Cookie Policy](/privacy/cookies/) for full detail. Summary:
...
This Schedule summarises rights that may apply based on your location. See the [General Privacy Policy](/privacy/general/) for procedures.
...
Reports of unlawful or infringing content may be submitted to [codefrydev@gmail.com](mailto:codefrydev@gmail.com) or via the [DMCA / Copyright Policy](/term/dmca/). Include sufficient detail for investigation.
...
Users whose access was suspended or terminated may appeal to [codefrydev@gmail.com](mailto:codefrydev@gmail.com) with subject **"Account Appeal"**, explaining the basis for reinstatement.
...
CodeFryDev publishes [llms.txt](https://codefrydev.in/llms.txt) and related documentation to guide AI crawlers and language models. Automated access must respect `robots.txt`, rate limits, and Article 52.
...
| Topic | Document |
| --- | --- |
| Terms of use | [General Terms](/term/general/) |
| Privacy & rights | [Privacy Policy](/privacy/general/) |
| Cookies | [Cookie Policy](/privacy/cookies/) |
| Subprocessors | [Subprocessor List](/privacy/subprocessors/) |
| Open source / MIT | Article 29, Schedule F |
| Analytics (GA, Clarity) | Article 43 |
| Security reports | [Security Policy](/term/security-disclosure/) |
| Copyright / DMCA | [DMCA Policy](/term/dmca/) |
| Trade marks | [Trade Mark Guidelines](/term/trademark/) |
| Accessibility | [Accessibility Statement](/term/accessibility/) |
| Community behaviour | [Code of Conduct](/term/code-of-conduct/) |
| Publisher contact | [Legal Notice](/term/legal-notice/) |
| Product-specific terms | [/term/](/term/) by category |
