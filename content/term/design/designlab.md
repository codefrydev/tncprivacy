...
title: "Design Lab — Supplementary Terms"
date: "2026-05-24"
description: "Product-specific Terms and Conditions for Design Lab within the CodeFryDev Ecosystem."
tags: ["CFD", "CodeFryDev", "Terms", "Design Lab"]
categories: ["design"]
product_url: "https://codefrydev.in/designlab/"
---

## Product-Specific Supplementary Terms

These Terms constitute a **Product-Specific Supplement** to the [CodeFryDev General Terms and Conditions of Use](/term/general/) (the **"General Terms"**). They apply exclusively to **Design Lab** (the **"Product"**), accessible at [https://codefrydev.in/designlab/](https://codefrydev.in/designlab/).

By effectuating access to or utilisation of the Product, the User voluntarily undertakes to be bound concurrently by the General Terms, the present Supplement, and the [General Privacy Policy](/privacy/general/). In the event of irreconcilable inconsistency, **this Supplement shall prevail solely with respect to Design Lab**.

### Product Identification

| Field | Detail |
| --- | --- |
| **Product Name** | Design Lab |
| **Category** | Design & Creative |
| **URL** | [https://codefrydev.in/designlab/](https://codefrydev.in/designlab/) |
...
(c) the User must not use Design Lab to infringe copyrights, trade marks, or publicity rights of third parties;
...
As a web-based property within the CodeFryDev Ecosystem, **Design Lab** participates in the platform-wide analytics and behavioural measurement programme described in **Article 43** of the [General Terms and Conditions of Use](/term/general/#article-43--analytics-telemetry-and-behavioural-measurement), including:
...
By accessing or otherwise utilising **Design Lab**, the User consents to such processing to the extent mandated by applicable data protection law. The User is **expressly cautioned against** entering authentication credentials, payment card information, government identifiers, or other categories of Special Category Data whilst session-recording technologies remain operative. Particulars are set forth in the [General Privacy Policy](/privacy/general/).


### Open Source Licence

**Design Lab** is part of the CodeFryDev open source portfolio. Its source code is typically published under the **MIT Licence**, unless a different licence is specified in the product repository `LICENSE` file.
...
Persons who fork or redistribute **Design Lab** assume sole responsibility for compliance with all transitive dependency licences and for excising or replacing analytics identifiers should they deploy an independently hosted instance.

**Material Distinction:** Access to **Design Lab** at `codefrydev.in` is governed by the present Supplement and the [General Privacy Policy](/privacy/general/) **concurrently with** any MIT or other open source licence applicable to the underlying source code. Analytics instrumentation (Google Analytics, Microsoft Clarity) applies exclusively to the hosted deployment.

### Relationship to Master Terms

Except as modified above, the [General Terms and Conditions of Use](/term/general/) govern **Design Lab** in full, including provisions relating to intellectual property, disclaimers, limitation of liability, indemnification, termination, and governing law (India).

### Amendments

These Supplementary Terms may be revised when **Design Lab** materially changes in scope or functionality. Revisions will be published at this URL with an updated effective date.
...
These Supplementary Terms for **Design Lab** are effective as of **24 May 2026**.
