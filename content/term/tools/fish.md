...
title: "Fish — Supplementary Terms"
date: "2026-05-24"
description: "Product-specific Terms and Conditions for Fish within the CodeFryDev Ecosystem."
...
These Terms constitute a **Product-Specific Supplement** to the [CodeFryDev General Terms and Conditions of Use](/term/general/) (the **"General Terms"**). They apply exclusively to **Fish** (the **"Product"**), accessible at [https://codefrydev.in/fish/](https://codefrydev.in/fish/).

By effectuating access to or utilisation of the Product, the User voluntarily undertakes to be bound concurrently by the General Terms, the present Supplement, and the [General Privacy Policy](/privacy/general/). In the event of irreconcilable inconsistency, **this Supplement shall prevail solely with respect to Fish**.
...
Fish is a browser-based or web-accessible utility designed to process, transform, analyse, visualise, or manage User-supplied data such as text, code, JSON, CSV, markup, or configuration artefacts. The User acknowledges and agrees that:
...
(b) unless expressly stated otherwise, the Service Provider **does not guarantee** the accuracy, completeness, or fitness for purpose of outputs, measurements, conversions, or diagnostics produced by Fish (including network speed tests, website profiling results, or resolution simulations);
...
As a web-based property within the CodeFryDev Ecosystem, **Fish** participates in the platform-wide analytics and behavioural measurement programme described in **Article 43** of the [General Terms and Conditions of Use](/term/general/#article-43--analytics-telemetry-and-behavioural-measurement), including:
...
By accessing or otherwise utilising **Fish**, the User consents to such processing to the extent mandated by applicable data protection law. The User is **expressly cautioned against** entering authentication credentials, payment card information, government identifiers, or other categories of Special Category Data whilst session-recording technologies remain operative. Particulars are set forth in the [General Privacy Policy](/privacy/general/).


### Open Source Licence

**Fish** is part of the CodeFryDev open source portfolio. Its source code is typically published under the **MIT Licence**, unless a different licence is specified in the product repository `LICENSE` file.
...
Persons who fork or redistribute **Fish** assume sole responsibility for compliance with all transitive dependency licences and for excising or replacing analytics identifiers should they deploy an independently hosted instance.

**Material Distinction:** Access to **Fish** at `codefrydev.in` is governed by the present Supplement and the [General Privacy Policy](/privacy/general/) **concurrently with** any MIT or other open source licence applicable to the underlying source code. Analytics instrumentation (Google Analytics, Microsoft Clarity) applies exclusively to the hosted deployment.

### Relationship to Master Terms

Except as modified above, the [General Terms and Conditions of Use](/term/general/) govern **Fish** in full, including provisions relating to intellectual property, disclaimers, limitation of liability, indemnification, termination, and governing law (India).

### Amendments

These Supplementary Terms may be revised when **Fish** materially changes in scope or functionality. Revisions will be published at this URL with an updated effective date.
...
These Supplementary Terms for **Fish** are effective as of **24 May 2026**.
