...
title: "Website Profiling — Supplementary Terms"
date: "2026-05-24"
description: "Product-specific Terms and Conditions for Website Profiling within the CodeFryDev Ecosystem."
...
These Terms constitute a **Product-Specific Supplement** to the [CodeFryDev General Terms and Conditions of Use](/term/general/) (the **"General Terms"**). They apply exclusively to **Website Profiling** (the **"Product"**), accessible at [https://codefrydev.in/WebsiteProfiling/](https://codefrydev.in/WebsiteProfiling/).

By effectuating access to or utilisation of the Product, the User voluntarily undertakes to be bound concurrently by the General Terms, the present Supplement, and the [General Privacy Policy](/privacy/general/). In the event of irreconcilable inconsistency, **this Supplement shall prevail solely with respect to Website Profiling**.

### Product Identification

| Field | Detail |
| --- | --- |
| **Product Name** | Website Profiling |
...
Website Profiling is a browser-based or web-accessible utility designed to process, transform, analyse, visualise, or manage User-supplied data such as text, code, JSON, CSV, markup, or configuration artefacts. The User acknowledges and agrees that:
...
(b) unless expressly stated otherwise, the Service Provider **does not guarantee** the accuracy, completeness, or fitness for purpose of outputs, measurements, conversions, or diagnostics produced by Website Profiling (including network speed tests, website profiling results, or resolution simulations);
...
By accessing or otherwise utilising **Website Profiling**, the User consents to such processing to the extent mandated by applicable data protection law. The User is **expressly cautioned against** entering authentication credentials, payment card information, government identifiers, or other categories of Special Category Data whilst session-recording technologies remain operative. Particulars are set forth in the [General Privacy Policy](/privacy/general/).


### Open Source Licence

**Website Profiling** is part of the CodeFryDev open source portfolio. Its source code is typically published under the **MIT Licence**, unless a different licence is specified in the product repository `LICENSE` file.
...
Persons who fork or redistribute **Website Profiling** assume sole responsibility for compliance with all transitive dependency licences and for excising or replacing analytics identifiers should they deploy an independently hosted instance.

**Material Distinction:** Access to **Website Profiling** at `codefrydev.in` is governed by the present Supplement and the [General Privacy Policy](/privacy/general/) **concurrently with** any MIT or other open source licence applicable to the underlying source code. Analytics instrumentation (Google Analytics, Microsoft Clarity) applies exclusively to the hosted deployment.

### Relationship to Master Terms

Except as modified above, the [General Terms and Conditions of Use](/term/general/) govern **Website Profiling** in full, including provisions relating to intellectual property, disclaimers, limitation of liability, indemnification, termination, and governing law (India).

### Amendments

These Supplementary Terms may be revised when **Website Profiling** materially changes in scope or functionality. Revisions will be published at this URL with an updated effective date.
...
These Supplementary Terms for **Website Profiling** are effective as of **24 May 2026**.
